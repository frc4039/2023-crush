...
public class Crusher extends SubsystemBase {
  ...
  DoubleSolenoid indexer = new DoubleSolenoid(25, PneumaticsModuleType.CTREPCM, 0, 1);
  DoubleSolenoid crush = new DoubleSolenoid(25,PneumaticsModuleType.CTREPCM, 2, 3);
  DoubleSolenoid denting = new DoubleSolenoid(25,PneumaticsModuleType.CTREPCM, 4, 5);
  DoubleSolenoid eject = new DoubleSolenoid(25,PneumaticsModuleType.CTREPCM, 6, 7);
    ...
    if(DriverStation.isTeleopEnabled()){
      switch(currentState){
        ...
        case STARTUP2: 
          ...
          denting.set(DoubleSolenoid.Value.kReverse);
        ...
        case DENTING: 
          indexer.set(DoubleSolenoid.Value.kReverse);
          denting.set(DoubleSolenoid.Value.kForward);
          crush.set(DoubleSolenoid.Value.kReverse);
          eject.set(DoubleSolenoid.Value.kReverse);
